...
export function getCommentsByArticleId(article_id) {
  return axios.get(
    `https://news-now.onrender.com/api/articles/${article_id}/comments`
  );
}
...
export function patchComment(comment_id, vote) {
  return axios.patch(
    `https://news-now.onrender.com/api/comments/${comment_id}`,
    { inc_votes: vote }
  );
}
...
export function getCommentsByUsername(username) {
  return axios.get(
    `https://news-now.onrender.com/api/users/${username}/comments`
  );
}
